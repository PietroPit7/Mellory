...
// Guide riconosciute: decide cosa diventa badge in copertina (aggiunte
// dall'utente).
...
export default function PlaceDetailScreen() {
  ...
  const automaticDetails = useMemo(
    ...
    [openingHours, phone, routeAddress, website]
  );
  ...
  // Unico link esterno: la pagina del locale su Google.
  function openGoogle() {
    Linking.openURL(
        ...
        <View style={[styles.mainPanel, { backgroundColor: colors.black }]}>
          ...
          <Section title="LINK">
            <PressableScale
              ...
              pressedScale={0.985}
            >
              <View style={styles.googleLinkDot} />
              <Text style={styles.googleLinkText}>Apri su Google</Text>
              <Text style={styles.googleLinkArrow}>↗</Text>
            </PressableScale>
          </Section>
